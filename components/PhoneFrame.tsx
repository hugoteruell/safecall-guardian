...
export default function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="relative mx-auto" style={{ width: 340 }}>
      {/* Glow */}
      <div className="absolute -inset-8 bg-gradient-to-br from-blue-500/20 via-purple-500/10 to-emerald-500/20 blur-3xl rounded-full -z-10" />
      ...
      <div className="relative bg-slate-950 rounded-[3rem] p-3 shadow-2xl ring-1 ring-slate-800">
        ...
        {/* Screen */}
        <div className="relative bg-white rounded-[2.4rem] overflow-hidden" style={{ height: 700 }}>
